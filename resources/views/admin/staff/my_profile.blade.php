            ...
            <div class="card-body">
               ...
               <div class="form-row">
                  <div class="col-md-12 mb-3"> &nbsp;                        
                     <button {{$disable_edit}}  class="mt-2 btn btn-primary btn-lg w-100  subject-btn ladda-button" data-style="expand-right" type="submit"> <strong> Save Admin Info  </strong></button>
                  </div>
               </div>
               <!-- form-row-->
