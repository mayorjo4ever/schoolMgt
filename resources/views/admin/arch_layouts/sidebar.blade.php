               ...
               @can('manage-finances')                
                <li>
                    ...
                    <ul  @if(Session::get('page')==="finance_management") class="mm-show" @endif >
                      @can('view-payment-items')
                        <li>
                            <a href="{{url('admin/payment-items')}}" @if(Session::get('subpage')==="payment_items")  class="mm-active"  @endif >
                              <i class="metismenu-icon"></i>Payment Items</a>
                        </li> 
                        @endcan
