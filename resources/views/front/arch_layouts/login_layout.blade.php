...
<html lang="en">
   ...
   <body >
      <div class="app-container app-theme-white body-tabs-shadow "  style="background:url({{asset('template/arch/assets/images/bg-inv.png')}}); background-repeat: no-repeat; background-size:cover; "> <!--fixed-sidebar-->
      <!--<div class="app-container app-theme-white body-tabs-shadow "  style="background:url({{asset('template/arch/assets/images/edu.gif')}}); background-repeat: no-repeat; background-size:cover; "> fixed-sidebar-->
